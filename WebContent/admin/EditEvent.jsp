...
<html>
  ...
  <body class="hold-transition skin-blue sidebar-mini">
    ...
    <div class="container">
					...
					<div class=" panel panel-heading">MODIFIER UN EVENEMENT</div>
					<div class="panel panel-body">
						<div class="panel-body" >
            <form accept-charset="UTF-8" role="form"action="UpdateEV.do" method="post">
                    <fieldset>
                    
                    <div class="form-group">
                	<label class="form-label">Id:</label>
                  <input type="hidden" class="form-control" value="${Event.id }" name="id" type="text"required="required">
                  <label>${Event.id }</label>
              </div>
                <div class="form-group">
                	<label class="form-label">Nom :</label>
                  <input  class="form-control"value=" ${Event.nom  }" name="nom" type="text"required="required">
              </div>
              <div class="form-group">
             	 <label class="form-label">Date:</label>
                  <input class="form-control" value=" ${Event.date }" name="date" type="text"required="required">
              </div>
              <div class="form-group">
               <label class="form-label">Email:</label>
                  <input class="form-control" value=" ${Event.lieu }"  name="lieu" type="text"required="required">
              </div>
