        ...
        <section class="sidebar">
         ...
         <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="AjouEvent.jsp"><i class="fa fa-user-plus"></i> Ajouter event</a></li>
                <li><a href="searchEvent.jsp"><i class="fa fa-edit"></i> Editer event</a></li>
                <li><a href="DeleteEvent.jsp"><i class="fa fa-trash-o"></i> Suprimer event </a></li>
                <li><a href="searchEvent.jsp"><i class="fa fa-search"></i> Rechercher event</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="setting.jsp">
      ...
      <div class="col-md-6 col-md-offset-2">
        <div class="panel panel-default">
          ...
          <div class="panel-body" >
            <form accept-charset="UTF-8" role="form"action="../AddEV.do" method="post">
                    <fieldset>
                <div class="form-group">
                	<label class="form-label">Nom:</label>
                  <input class="form-control" placeholder="semaine de recherche " name="nom" type="text"required="required">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
               <label class="form-label">Lieu:</label>
                  <input class="form-control" placeholder="opera hanoi " name="lieu" type="text"required="required">
              </div>
