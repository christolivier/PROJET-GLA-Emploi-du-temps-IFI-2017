...
<html>
  ...
  <body class="hold-transition skin-blue sidebar-mini">
         ...
         <ul class="sidebar-menu">
            ...
            <li class="treeview">
             <a href="#">
              ...
              <ul class="treeview-menu">
                <li><a href="admin/AjouProf.jsp"><i class="fa fa-user-plus"></i> Ajouter un prof</a></li>
                <li><a href="admin/EditProf.jsp"><i class="fa fa-edit"></i> Editer un prof</a></li>
                <li><a href="admin/DeleteProf.jsp"><i class="fa fa-trash-o"></i> Suprimer un prof</a></li>
                <li><a href="admin/searchProf.jsp"><i class="fa fa-search"></i> Rechercher un prof</a></li>
        ...
        <section class="content-header">
          <h1>
           ...
           <ol class="breadcrumb" style="list-style-type: none; ">
            <li><a href="admin/logout2.jsp"><i class="fa fa-power-off"></i> Deconnexion</a></li>
          </ol>
        </section>
    ...
    <div class="container">
					...
					<div class=" panel panel-heading">RECHERCHER UN EVENEMENT</div>
					<div class="panel panel-body">
						<form action="../searchEV.do" method="get">
							<label>Entrer une date:</label>
							<input type="Date"name="motCle" value="${modelEV.motCle}">
						...
						<table class="table table-striped">
							...
							<c:forEach items="${modelEV.event}" var="e">
								<tr>
									<td>${e.id} </td>
									<td>${e.nom} </td>
									<td>${e.date} </td>
									<td>${e.lieu} </td>
									<td><a onclick="return confirm('Etes vous sûre?')" href="SupprimeEV.do?id=${e.id}">Supprimer</a> </td>
									<td><a href="EditEV.do?id=${e.id}">Modifier</a> </td>
								</tr>
							</c:forEach>
						</table>
