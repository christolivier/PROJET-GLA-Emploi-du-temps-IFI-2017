          ...
          <div class="user-panel">
            ...
            <div class="pull-left info">
              ...
              <a href="#"><i class="fa fa-circle text-success"></i> Online</a>
         				...
         				<%
						if (promoposition.equals("A")) {
						%>
						<%@include file="/inc/inc_admin_navigation2.jsp"%>
						<%
							} else {
						%>
						<%@include file="/inc/inc_user_navigation2.jsp"%>
						<%
							}
						%>
      </section>
                 ...
                 <div class="box-body no-padding" style="color:#000000;">
					...
					<form class="form-inline"action="TacheStatut.do" method="get">
		 					 <div class="form-group">
								 <label class="col-sm-12 control-label">SELECTION L'EMPLOI DU TEMPS DE LA PROMOTION A REMPLIR</label>
								  </div>
			  					  <div class="form-group" name='idmembre'>
			    				   <select class="form-control">
									  <option>Promotion 21</option>
									  <option>Promotion 22</option>
									  <option>Promotion 23 </option>
									</select>
			  					</div>
