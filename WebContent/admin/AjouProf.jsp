      ...
      <div class="col-md-6 col-md-offset-2">
        <div class="panel panel-default">
          ...
          <div class="panel-body" >
            <form accept-charset="UTF-8" role="form"action="../Addprof.do" method="post">
                    <fieldset>
                <div class="form-group">
                	<label class="form-label">Nom et Prenom:</label>
                  <input class="form-control" placeholder="quang olivier " name="profname" type="text"required="required">
              </div>
              <div class="form-group">
             	 <label class="form-label">Cours Dispensé:</label>
                  <input class="form-control" placeholder="Anglais " name="cours" type="text"required="required">
              </div>
              <div class="form-group">
               <label class="form-label">Email:</label>
                  <input class="form-control" placeholder="kouadio.p21@ifi.edu.vn " name="email" type="text"required="required">
              </div>
              <div class="form-group">
               <label class="form-label">MiniCV:</label>
                  <textarea class="form-control" rows="4" name="minicv" ></textarea>
              </div>
