...
<html>
  ...
  <body class="hold-transition skin-blue sidebar-mini">
    ...
    <div class="container">
					...
					<div class=" panel panel-heading">MODIFIER UN PROFESSEUR</div>
					<div class="panel panel-body">
						<div class="panel-body" >
            <form accept-charset="UTF-8" role="form"action="Update.do" method="post">
                    <fieldset>
                    
                    <div class="form-group">
                	<label class="form-label">Id:</label>
                  <input type="hidden" class="form-control" value="${Professeur.id }" name="id" type="text"required="required">
                  <label>${Professeur.id }</label>
              </div>
                <div class="form-group">
                	<label class="form-label">Nom et Prenom:</label>
                  <input  class="form-control"value=" ${Professeur.nomprenom }" name="profname" type="text"required="required">
              </div>
              <div class="form-group">
             	 <label class="form-label">Cours Dispensé:</label>
                  <input class="form-control" value=" ${Professeur.cours }" name="cours" type="text"required="required">
              </div>
              <div class="form-group">
               <label class="form-label">Email:</label>
                  <input class="form-control" value=" ${Professeur.email }"  name="email" type="text"required="required">
              </div>
              <div class="form-group">
               <label class="form-label">MiniCV:</label>
                  <textarea class="form-control" rows="4" value=" ${Professeur.minicv }" name="minicv"  >${Professeur.minicv }</textarea>
              </div>
